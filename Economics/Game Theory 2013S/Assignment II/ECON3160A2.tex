...
\begin{document}
\title{ECON 3160 Game Theory \\Assignment $2^{\text{st}}$}
...
\begin{description}
    ...
    \begin{center}
                     {\bf You \hspace{28mm} Competitor \hspace{28mm}You}
    ...
    {\bf (a):}\\
        The extended belief diagram:
        \begin{center}
                         {\bf You \hspace{32mm} Jury \hspace{32mm}You}
    ...
    The extended belief diagram:
    \begin{center}
                    \includegraphics[angle=0, width=0.7\textwidth]{ECON3160A1P2}\\
    \end{center}\newpage
    The epistemic model:
    \begin{center}
        \begin{tabular}{cl}
